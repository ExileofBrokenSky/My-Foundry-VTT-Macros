//For use with Midi-Qol - with the workflow setting: Add macro to call on use checked. Make a macro and copy paste this text into it and make sure the macro is set to 'script' and save it. Then on your item that will be a repair kit, in its 'On Use Macro' field in the details tab enter that name of the macro.
